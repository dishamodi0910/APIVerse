...
|[Codeforces API](./Codeforces_API/)|This API gets the users Codeforces rating changes and displays it in form of a graph. The user can use it in any website of their choice. |
